...
permission is not required because v1's explicit Android rule is simply **screen
...
Multi-user limitation: v1 tracks only the Android profile in which it is installed
